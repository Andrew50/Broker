...
<div class="popout-menu" style="min-height: {innerHeight}px;" class:visible>
  ...
  {/if}
     <!--                       <tr class:clean-green={!annotation[3]}>
                                <button on:click={() => {
                                    currentEntry.set('');
                                    if(visibleAnnotationID == annotation[4]){
                                        visibleAnnotationID = null;
                                    ...
                                    {annotation[1]} {toDT(annotation[0])} {annotation[2]}
                                </button>

                            </tr>
                            {#if visibleAnnotationID == annotation[4]}
                            <tr>
                                <input type="text" bind:value={$currentEntry} placeholder="">
                            </tr>
                            <tr>
                                <button on:click={() => saveAnnotation(i)}>                                
                                    Save
                                </button>
                                <button on:click={() => {request(null,true,'delAnnotation',annotation[4]);
                                annotations.update((a) => {a.splice(i,1);return a;});
                                }}>                                
                                    Delete
                                </button>
