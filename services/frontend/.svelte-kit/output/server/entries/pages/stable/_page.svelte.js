...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `  <div class="container svelte-smk323"><div class="button-container"><button class="match-button svelte-smk323" data-svelte-h="svelte-182r6iu"><div>M</div> <div>A</div> <div>T</div> <div>C</div> <div>H</div></button> <button class="screener-button svelte-smk323" data-svelte-h="svelte-17xqvtb"><div>S</div> <div>C</div> <div>R</div> <div>E</div> <div>E</div> <div>N</div> <div>E</div> <div>R</div></button> <div class="${["popout-menu svelte-smk323", ""].join(" ").trim()}" style="${"min-height: " + escape(innerHeight, true) + "px;"}">${``}</div> <div class="${["popout-menu svelte-smk323", ""].join(" ").trim()}" style="${"min-height: " + escape(innerHeight, true) + "px;"}">${``}</div></div></div> ${validate_component(Chart, "Chart").$$render($$result, Object.assign({}, { width: innerWidth - 300 }, { height: innerHeight - 40 }, options), {}, {
    default: () => {
  ...
  })} ${escape(chartTicker)} <a href="/test" data-svelte-h="svelte-1j83awr">test</a> <input class="input-overlay svelte-smk323" style="${"display: " + escape(TickerBoxVisible, true) + ";"}"${add_attribute("this", TickerBox, 0)}${add_attribute("value", TickerBoxValue, 0)}>`;
});
export {
  Page as default
};
