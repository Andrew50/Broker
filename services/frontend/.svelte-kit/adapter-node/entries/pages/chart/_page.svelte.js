import { d as get_store_value, c as create_ssr_component, a as subscribe, e as escape, b as add_attribute, f as each, v as validate_component } from "../../../chunks/ssr.js";
...
const Match = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${["popout-menu", visible ? "visible" : ""].join(" ").trim()}" style="${"min-height: " + escape(innerHeight, true) + "px;"}">${visible ? `<form><div class="form-group"><input type="text" id="ticker" name="ticker" placeholder="Enter Ticker" required${add_attribute("value", ticker, 0)}></div> <div class="form-group"><input type="text" id="tf" name="tf" placeholder="Enter TF" required${add_attribute("value", tf, 0)}></div> <div class="form-group"><input type="text" id="dt" name="dt" placeholder="Enter Date Time"${add_attribute("value", dt, 0)}></div> <div class="form-group" data-svelte-h="svelte-15bpodi"><input type="submit" value="FETCH"></div></form> ${$match_data.length > 0 ? `<table><thead data-svelte-h="svelte-k55fip"><tr><th>Ticker Symbol</th> <th>Timestamp</th> <th>Value</th></tr></thead> <tbody>${each($match_data, (item) => {
    return `<tr> <td>${escape(item[0])}</td>  <td>${escape(item[1])}</td>  <td>${escape(item[2])}</td>  </tr>`;
  })}</tbody></table>` : ``}` : ``} </div>`;
});
const css$8 = {
...
const Table = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${``} ${rows.length > 0 ? `<div class="scrollable-table svelte-8p5mmp"><table><thead><tr>${each(headers, (header) => {
    return `<th>${escape(header)}</th>`;
  })}</tr></thead> <tbody>${each(rows, (item) => {
...
const Screener = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${["popout-menu svelte-wtc9ax", visible ? "visible" : ""].join(" ").trim()}" style="${"min-height: " + escape(innerHeight, true) + "px;"}">${visible ? ` ${each($setups_list, (setup) => {
    return `<div><label class="setup-item svelte-wtc9ax"><input type="checkbox" checked> ${escape(setup[0])} </label> </div>`;
  })} <form class="input-form svelte-wtc9ax"><div class="form-group svelte-wtc9ax"><label for="ticker" data-svelte-h="svelte-1irgfrs">Ticker:</label> <input type="text" id="ticker" placeholder="Ticker"${add_attribute("value", ticker, 0)}></div> <div class="form-group svelte-wtc9ax"><label for="datetime" data-svelte-h="svelte-80sz5g">Datetime:</label> <input type="text" id="datetime" placeholder="YYYY-MM-DD HH:MM"${add_attribute("value", datetime, 0)}></div> <input type="submit" value="Screen"></form> ${validate_component(Table, "Table").$$render(
    $$result,
    {
...
const Chart_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `  ${validate_component(Chart, "Chart").$$render($$result, Object.assign({}, { width: innerWidth - 500 }, { height: innerHeight - 20 }, options), {}, {
    default: () => {
...
const Trainer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${["popout-menu", visible ? "visible" : ""].join(" ").trim()}">${visible ? `<div>${validate_component(Table, "Table").$$render(
    ...
    {},
    {}
  )}</div> ${``} ${selected_setup == "" ? `<div class="setup-details svelte-15wzxpo"> <div class="controls"><input class="inp svelte-15wzxpo" type="text" placeholder="Setup Name"${add_attribute("value", setupName, 0)}> <input class="inp svelte-15wzxpo" type="text" placeholder="Setup Timeframe"${add_attribute("value", setupTimeframe, 0)}> <input class="inp svelte-15wzxpo" type="text" placeholder="Setup Length"${add_attribute("value", setupLength, 0)}></div> <div><button data-svelte-h="svelte-9hnfwq">Create Setup</button> <button data-svelte-h="svelte-75aojd">Delete Setup</button></div></div>` : ``} ${selected_setup ? `<button data-svelte-h="svelte-184wmyr">Train</button> <p>Is this a ${escape(selected_setup)}?</p> <div><button data-svelte-h="svelte-1xwf6ia">Yes</button> <button data-svelte-h="svelte-5722s9">No</button> <button data-svelte-h="svelte-1s1re4j">Back</button></div>` : ``}` : ``} </div>`;
});
const css$4 = {
...
const Study = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_setups_list();
  return `<div class="${["popout-menu", visible ? "visible" : ""].join(" ").trim()}" style="${"min-height: " + escape(innerHeight, true) + "px;"}">${visible ? `<div><div><select><option disabled selected value="" data-svelte-h="svelte-6jqb3p">Select a watchlist</option>${each($setups_list, (key) => {
    return `<option${add_attribute("value", key[0], 0)}>${escape(key[0])}</option>`;
  })}</select> <button data-svelte-h="svelte-19zovy0">Fetch [dev]</button></div> <div><textarea class="large-textarea svelte-1wpv272" placeholder="Enter text here">${escape("")}</textarea></div> <div><button data-svelte-h="svelte-syimuw">Next</button></div></div>` : ``} </div>`;
});
const css$3 = {
  code: "@import './style.css';",
  map: null
...
const Account = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${["popout-menu", visible ? "visible" : ""].join(" ").trim()}" style="${"min-height: " + escape(innerHeight, true) + "px;"}">${visible ? `<p data-svelte-h="svelte-1jt6o8g">account</p><p></p>` : ``} </div>`;
});
const css$2 = {
  code: "@import './style.css';",
  map: null
...
const Settings = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${["popout-menu", visible ? "visible" : ""].join(" ").trim()}" style="${"min-height: " + escape(innerHeight, true) + "px;"}">${visible ? `<p data-svelte-h="svelte-129igwq">settings</p><p></p>` : ``} </div>`;
});
const css$1 = {
  code: "@import './style.css';",
  map: null
...
const Watchlist = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${["popout-menu", visible ? "visible" : ""].join(" ").trim()}">${visible ? `<div><select><option disabled selected value="" data-svelte-h="svelte-6jqb3p">Select a watchlist</option>${each(watchlist_keys, (key) => {
    return `<option${add_attribute("value", key, 0)}>${escape(key)}</option>`;
  })}</select> <input type="text" placeholder="Name"${add_attribute("value", watchlist_name, 0)}> <button data-svelte-h="svelte-e1x6ab">Create New</button></div> <div><input type="text" placeholder="Ticker"${add_attribute("value", ticker_name, 0)}> <button data-svelte-h="svelte-znkr9m">Add Ticker</button></div> ${``}` : ``} </div>`;
});
const css = {
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="button-container svelte-1247y1f"><button class="button svelte-1247y1f" data-svelte-h="svelte-trfpni"><im class="icon svelte-1247y1f" src="/watchlist.png" alt=""></im></button> <button class="button svelte-1247y1f" data-svelte-h="svelte-18ayj7n"><img class="icon svelte-1247y1f" src="/match.png" alt=""></button> <button class="button svelte-1247y1f" data-svelte-h="svelte-qw5kqt"><img class="icon svelte-1247y1f" src="/screener.png" alt=""></button> <button class="button svelte-1247y1f" data-svelte-h="svelte-16qpzf7"><img class="icon svelte-1247y1f" src="/trainer.png" alt=""></button> <button class="button svelte-1247y1f" data-svelte-h="svelte-y3fe5j"><img class="icon svelte-1247y1f" src="/study.png" alt=""></button> <button class="button svelte-1247y1f" data-svelte-h="svelte-10izfn"><img class="icon svelte-1247y1f" src="/account.png" alt=""></button> <button class="button svelte-1247y1f" data-svelte-h="svelte-c7njwm"><im class="icon svelte-1247y1f" src="/settings.png" alt=""></im></button></div> ${validate_component(Watchlist, "Watchlist").$$render($$result, { visible: active_menu == "watchlist" }, {}, {})} ${validate_component(Match, "Match").$$render($$result, { visible: active_menu == "match" }, {}, {})} ${validate_component(Screener, "Screener").$$render($$result, { visible: active_menu == "screener" }, {}, {})} ${validate_component(Trainer, "Trainer").$$render($$result, { visible: active_menu == "trainer" }, {}, {})} ${validate_component(Study, "Study").$$render($$result, { visible: active_menu == "study" }, {}, {})} ${validate_component(Account, "Account").$$render($$result, { visible: active_menu == "account" }, {}, {})} ${validate_component(Settings, "Settings").$$render($$result, { visible: active_menu == "settings" }, {}, {})} ${validate_component(Chart_1, "Chart").$$render($$result, {}, {}, {})}`;
});
export {
  Page as default
};
