...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `
<main class="svelte-877in5"><div class="container svelte-877in5"><h1>Sign In</h1>
    <input type="text" placeholder="Username" class="svelte-877in5"${add_attribute("value", username, 0)}>
    <input type="password" placeholder="Password" class="svelte-877in5"${add_attribute("value", password, 0)}>
    <button class="svelte-877in5">Sign In</button>
    <button class="create-account-btn svelte-877in5">Create Account</button>
    <p class="error-message svelte-877in5">${escape($errorMessage)}</p></div>
</main>`;
});
export {
  Page as default
